...
const SITE = {
  ...
  gallery: {
    photos: Array.from({ length: 16 }, (_, i) => ({
      image: `https://picsum.photos/600/400?random=${80 + i}`,
      caption: `Ashrama Activity ${i + 1}`
    })),
    videos: [
      { title: "Swami Vivekananda Jayanti 2024", youtubeId: "dQw4w9WgXcQ" },
      { title: "Evening Arati at RKVA Bidar", youtubeId: "dQw4w9WgXcQ" },
      { title: "Youth Camp 2023 Highlights", youtubeId: "dQw4w9WgXcQ" },
      { title: "Guru Purnima Celebrations", youtubeId: "dQw4w9WgXcQ" }
    ]
  },
